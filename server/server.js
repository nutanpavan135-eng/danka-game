...
const { rooms, loadRooms, saveRooms, getStoreMode } = require("./src/rooms/roomStore");
...
app.get("/", (req, res) => res.send("Danka backend server is running — Prototype 5.27 persistent room storage ready"));
app.get("/health", (req, res) => res.json({
  status: "ok",
  prototype: "5.27-persistent-room-storage",
